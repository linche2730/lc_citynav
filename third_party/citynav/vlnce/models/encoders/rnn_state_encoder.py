...
class RNNStateEncoder(nn.Module):
    ...
    def single_forward(
        ...
        hidden_states = torch.where(
            masks.view(1, -1, 1).view(torch.bool), hidden_states, hidden_states.new_zeros(())  # to silence deprecation warnings: masks.view(1, -1, 1), hidden_states, hidden_states.new_zeros(())
        )
